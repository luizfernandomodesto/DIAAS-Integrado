#!/usr/bin/env python3
# Roda o classificador real do Thiago sobre um paciente, sem passar pelo hardware.
import argparse
import ast
import os
...
# Extrai a FCN_Apresentacao1D direto do loopTreino.py real, pra nunca rodar
# uma versão desatualizada da rede por engano
...
def main():
    ...
    # Abre o .pt e faz a mesma seleção e normalização do preProcessamento.py
    ...
    # Carrega os pesos treinados de verdade e roda o forward()
